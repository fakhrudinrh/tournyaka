    ...
    <div class="bg-dark bg-opacity-50 py-5" style="background-size: cover;">
        <div class="container-lg py-4 mb-5 pb-5 px-3 px-sm-4 px-lg-0">
            ...
            <div class="col-md-8 col-lg-6 font-viga">
                <p class="lead mb-4 text-warning">Tournyaka merupakan sebuah platform pariwisata berbasis digital dengan konsep smart tourism yang memudahkan wisatawan untuk mendapatkan layanan jasa pariwisata di Pangandaran</p>
    ...
    <div class="container-lg mt-5 mb-5 px-3 px-sm-4 px-lg-0">
        <div class="mt-md-4 pt-md-4 font-poppins">
            <p class="lead fs-text">
                <strong class="fw-bold">Tournyaka</strong> merupakan sebuah platform pariwisata yang menyediakan berbagai kebutuhan wisatawan dalam berwisata ke Pangandaran seperti layanan pemandu wisata (tour guide), paket wisata, dan rencana perjalanan (iteneraty planner) yang menawarkan pengalaman yang lebih personal dimana wisatawan dapat mengatur rencana perjalanan ke berbagai destinasi wisata Pangandaran yang diinginkan.
            </p>
        </div>
